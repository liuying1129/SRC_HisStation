...
begin
  ...
  Label2.Caption:='联系电话:'+ini.ReadString('Interface','companytel','13701248644');
  ini.Free;
...
begin
  ADOQuery1.Close;
  ADOQuery1.SQL.Clear;
  ADOQuery1.SQL.Text:='select worker.id,worker.passwd,worker.account_limit,CommCode.Name '+
        ' from worker left join CommCode on CommCode.unid=worker.pkdeptid and CommCode.TypeName =''部门'' ';
  ADOQuery1.Open;
  ...
  begin
    ...
    department_name:=ADOQuery1.fieldbyname('Name').AsString;
